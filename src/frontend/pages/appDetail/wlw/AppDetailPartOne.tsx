          ...
          <div>
            ...
            <Grid container className={classes.grids}>
              <Grid item md={6} className={classes.grid}>
                ...
                <img style={{ width: 350 }} src={"/static/images/appDetail/33.png"}/>
              </Grid>
              <Grid item md={6} className={classes.grid}>
                <p>2.创建目标变量：根据误差范围，选取有效范围内数据；</p>
                <img style={{ width: 350 }} src={"/static/images/appDetail/34.png"}/>
              </Grid>
            </Grid>
            ...
            <Grid container className={classes.grids}>
              <Grid item md={6} className={classes.grid}>
                ...
                <img style={{ width: 350 }} src={"/static/images/appDetail/35.png"}/>
              </Grid>
              <Grid item md={6} className={classes.grid}>
                <p>4.模型训练：
                ...
                <img style={{ width: 350 }} src={"/static/images/appDetail/36.png"}/>
              </Grid>
            </Grid>
          ...
          <div>
            ...
            <Grid container className={classes.grids}>
              <Grid item md={6} className={classes.grid}>
                ...
                <img style={{ width: 350 }} src={"/static/images/appDetail/38.png"}/>
              </Grid>
              <Grid item md={6} className={classes.grid}>
                <p>3.
                  发电量误差对风机单因子的响应：
                ...
                <img style={{ width: 350 }} src={"/static/images/appDetail/39.png"}/>
              </Grid>
            </Grid>
            ...
            <Grid container className={classes.grids}>
              <Grid item md={12} className={classes.grid}>
                ...
                <img style={{ width: 800 }} src={"/static/images/appDetail/40.png"}/>
              </Grid>
            </Grid>
          </div>
