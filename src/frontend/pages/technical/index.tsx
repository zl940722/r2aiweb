        ...
        <Grid container xs={12}>
          <Grid item xs={12} md={9} lg={7} xl={5} className={classes.center}>
            <Typography component={'div'} align='center'>
              为各行业企业、个人提供世界领先的人工智能开发及应用平台，帮助客户以最简单、便捷、高效的方式， 建立最优质的机器学习模型，为每个有价值的业务场景自主构建AI应用，实现业务升级和企业AI赋能。
            </Typography>
          </Grid>
        </Grid>
        <Grid container xs={12}>
          <Grid container xs={10} xl={8} className={`${classes.center} ${classes.iconContent}`} wrap='nowrap'>
            <Grid container xs={4} className={classes.pointer} direction='column' alignItems='center' onMouseOver={imgOver(0)} onMouseOut={imgOver(-1)}>
            ...
            <Grid container xs={4} className={classes.pointer} direction='column' alignItems='center' onMouseOver={imgOver(1)} onMouseOut={imgOver(-1)}>
              <div className={classes.icon}>
            ...
            <Grid container xs={4} className={classes.pointer} direction='column' alignItems='center' onMouseOver={imgOver(2)} onMouseOut={imgOver(-1)}>
              <div className={classes.icon}>
      ...
      <Grid container className={classes.content} component='div'>
        ...
        <Grid container xs={12} className={classes.images} >
          <Grid container xs={12} justify='center' alignItems='center' style={{ marginBottom: '-55px' }}>
            <Grid item className={`${classes.imageContent} ${classes.pointer}`} component={'img'} src={`/static/images/technical/1xz${index === 1 ? 'a' : ''}.png`} alt="1xz" onMouseOver={onOver(1)} onMouseOut={onOver(-1)} />
          ...
          <Grid container xs={12} justify='center' alignItems='center' style={{ marginTop: '-55px' }}>
            <Grid item className={`${classes.imageContent} ${classes.pointer}`} component={'img'} src={`/static/images/technical/3xz${index === 3 ? 'a' : ''}.png`} alt="3xz" onMouseOver={onOver(3)} onMouseOut={onOver(-1)} />
            <Grid item className={`${classes.imageContent} ${classes.pointer}`} component={'img'} src={`/static/images/technical/4xz${index === 4 ? 'a' : ''}.png`} alt="4xz" onMouseOver={onOver(4)} onMouseOut={onOver(-1)} />
          </Grid>
        </Grid>
        <Popper
