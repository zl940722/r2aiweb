        ...
        <Row>
          <Col span={8}>
            <div className={classes.item}>
              ...
              <div style={{width:300,margin:'0 auto'}}>
                <h4 style={{ textAlign: "center", fontSize: "1.4rem", padding: 20 }}>渠道代理合作</h4>
          ...
          <Col span={8}>
            ...
            <div className={classes.item}>
              ...
              />
              <div style={{width:300,margin:'0 auto'}}>
                <h4 style={{ textAlign: "center", fontSize: "1.4rem", padding: 20 }}>商务技术合作</h4>
                <p><b>技术合作：</b>
          ...
          <Col span={8}>
            <div className={classes.item}>
              ...
              />
              <div style={{width:300,margin:'0 auto'}}>
              <h4 style={{ textAlign: "center", fontSize: "1.4rem", padding: 20 }}>投资战略合作</h4>
              <p><b>
                投资人：
              </b>
