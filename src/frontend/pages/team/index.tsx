      ...
      <div className={classes.content}>
        <div className={classes.content_div}>
          ...
          <Grid container className={classes.items} direction={"row"}>
            <Grid item xs={4}>
              <div className={classes.item}
                ...
                <div className={"item_div"}>
                  <p style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 0 }}>黄一文</p>
                  <p style={{ fontWeight: 'bold', marginBottom: 0 }}>
                    首席执行官，联合创始人
                  </p>
                  <p style={{ marginTop: 35 }}>黄一文具有20余年大数据和人工智能行业经验。90年代就开始书写神经网络模型。在Sybase，他为Sybase
            ...
            <Grid item xs={4}>
              <div className={classes.item}
                onMouseOver={mouseLeave("item7")}
                onMouseMove={mouseOver("item7")}
                onMouseLeave={mouseLeave("item7")}>
                <img
                  className={show.item7 ? "img_hover" : "img"}
                  src="/static/images/team/7.png"
                  width={"100%"}
                  alt="R2.ai"
                />
                <div className={"item_div"}>
                  <p style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 0 }}>孙俊毅</p>
                  <p style={{ fontWeight: 'bold', marginBottom: 0 }}>
                    首席技术官，联合创始人
                  </p>
                  <p style={{ marginTop: 35 }}>孙俊毅, 网景老兵，具有20余年大型系统研发经验，热衷于建立机器学习系统解决行业问题。在网景和美国在线，他带领团队开发分布式大数据系统，启发式推导系统，及其云服务的研发。在RT等多家初创公司，他全面负责游戏软件的人工智能及实时系统的开发。孙俊毅是ASU计算机科学硕士, 此前在ASU Prism三维实验室工作。</p>
                </div>
              </div>
            </Grid>
            <Grid item xs={4}>
              <div className={classes.item}
                ...
                <div className={"item_div"} onMouseOver={mouseLeave} onMouseMove={mouseOver} onMouseLeave={mouseLeave}>
                  <p style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 0 }}>孟迪</p>
                  <p style={{ fontWeight: 'bold', marginBottom: 0 }}>
                    首席科学家，联合创始人
                  </p>
                  <p style={{ marginTop: 35 }}>孟迪在分析实践和统计研究方面拥有超过20年的经验。在Cigna和Kaiser
            ...
            <Grid container className={classes.items} direction={"row"}>
              ...
              <Grid item xs={4}>
                <div className={classes.item}
                  ...
                  />
                  <div className={"item_div"}>
                    <p style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 0 }}>宣晓华</p>
                    <p style={{ marginTop: 35 }}>他是华院数据的创始人和主席，一家在中国最有影响力的专注于大数据和人工智能技术研发及孵化的公司。他还共同创办了eBao
              ...
              <Grid item xs={4}>
                <div className={classes.item}
                  ...
                  />
                  <div className={"item_div"}>
                    <p style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 0 }}>林富元（源）</p>
                    <p style={{ marginTop: 35 }}>林富元是Acorn
          ...
          <Grid container className={classes.items} direction={"row"}>
            <Grid item xs={4}>
              <div className={classes.item}
                ...
                />
                <div className={"item_div"}>
                  <p style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 0 }}>Jason G. Cooper</p>
                  <p style={{ marginTop: 35 }}>Cooper先生是他自己的咨询公司的所有者和董事总经理。他是一名具有20多年的影响力的资深的商业管理人员。擅长数据，分析，信息和技术，所涉领域涵盖营利性，非营利性和政府部门，其中包括Blue
